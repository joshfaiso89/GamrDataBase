        ...
        <Row className='d-flex flex-row game-info'>
          ...
          <Col sm='8' md='8' className='game-info--data d-flex flex-column justify-content-between align-items-start'>
            <div className='game-info--description'>
              <h1 className='game-info--title'>{gameData.name != null ? gameData.name: "No Data Available"}</h1>
              <div className='my-3'>
              ...
              <p className='game-info--plot'>{gameData.summary != null  ? gameData.summary: "No Data Available"}</p>
            </div>
            <div className='game-info--stats d-flex justify-content-between align-items-center'>
              <div><p>Release Date: <span className='release-date'>{gameData.first_release_date != null ? gameData.first_release_date: "No Data Available"}</span></p></div>
              <div><p>Time to beat: <span className='beat-time'>normal time here</span></p></div>
              <div><p>Franchise: <span className='franchise'>{gameData.franchise != null ? gameData.franchise.name: "No Data Available"}</span></p></div>
            </div>
          </Col>
        </Row>
